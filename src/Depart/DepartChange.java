...
public class DepartChange extends JFrame {
	...
	private void jbInit() throws Exception {
		...
		jLabel1.setText("Modifiy Department");
	...
	public String jButton1_actionPerformed(ActionEvent e) {
		...
		if (jComboBox1.getSelectedIndex() == 0) {
			jOptionPane1.showMessageDialog(this, "Please select department!", "alert", JOptionPane.INFORMATION_MESSAGE, null);
			s = "Please select department!";
		} else if (jComboBox2.getSelectedIndex() == 0) {
			jOptionPane1.showMessageDialog(this, "Please select major!", "alert", JOptionPane.INFORMATION_MESSAGE, null);
			s = "Please select major!";
		} else {
			xueYuan();
			zhuanYe();
			try {
				...
				if (departExist && specExist) {
					...
					conn.getUpdate("insert into tb_spec (departName,specName) values ('"
							+ String.valueOf(jComboBox1.getSelectedItem()) + "','"
							+ String.valueOf(jComboBox2.getSelectedItem()) + "')");
					jOptionPane1.showMessageDialog(this, "Congratulations! Department has been modified successfully", "alert", JOptionPane.INFORMATION_MESSAGE, null);
					s = "Congratulations! Department has been modified successfully";
				} else if (!departExist && !specExist) {
					conn.getUpdate("delete from tb_spec where specId='" + Integer.valueOf(find) + "'");
					conn.getUpdate("insert into tb_spec (departName,specName) values ('"
							+ String.valueOf(jComboBox1.getSelectedItem()) + "','"
