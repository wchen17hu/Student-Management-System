...
public class DepartManager extends JFrame {
	...
	Object[][] arrData = {};
	String[] arrField = { "Major ID", "Department Name", "Major Name" };
	...
	public void jButton4_actionPerformed(ActionEvent e) {
		getM();
		if (intRow == -1) {
			jOptionPane1.showMessageDialog(this, "Please select the department you want to modify!", "alert", JOptionPane.INFORMATION_MESSAGE, null);
		} else {
	...
	public void jButton5_actionPerformed(ActionEvent e) {
		getM();
		if (intRow == -1) {
			jOptionPane1.showMessageDialog(this, "Please select the department you want to delete!", "alert", JOptionPane.INFORMATION_MESSAGE, null);
		}
		try {
			conn.getUpdate("delete from tb_spec where specId='" + Integer.valueOf(find) + "'");
			jOptionPane1.showMessageDialog(this, "Delete Successfully", "alert", JOptionPane.INFORMATION_MESSAGE, null);
		} catch (Exception ce) {
